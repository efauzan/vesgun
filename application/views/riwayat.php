...
<head>
  <title>Vesgun Scooter - Tagihan Pesanan <?= $this->session->userdata('nama_pelanggan') ?></title>
  <meta charset="utf-8">
      ...
      <div class="site-navbar-top">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="logovesgun">
                <!-- <a href="<?= base_url('/') ?>" class="js-logo-clone">VESGUN SCOOTER</a> -->
                <a href="<?= base_url('/') ?>"> 
                ...
                <ul>
                  <li>
                    <a href="<?= base_url('cart/keranjang') ?>" class="site-cart">
                      <span class="icon icon-shopping_cart"></span>Keranjang
                ...
                <tbody>
                  ...
                  foreach ($riwayat as $result) { ?>
                    <tr>
                      ...
                      <td>
                        <?php if ($result->status_pesanan == "konfirmasi" or $result->status_pesanan ==  "proses" or $result->status_pesanan ==  "delivery") { ?>
                          <label style="color:red;">Sudah Dikonfirmasi</label>
                        <?php } else { ?>
        ...
        <div class="row pt-5 mt-2 text-center">
          <div class="col-md-12">
            <p>
              ...
              </script> by <a href="" target="_blank" class="text-primary">Vesgun Scooter</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
